  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', fontFamily: 'var(--font-sans)' }}>
      <div className="login-left-panel" style={{ display: 'none', width: '48%', flexShrink: 0, background: theme.leftBase, position: 'relative', overflow: 'hidden', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '60px 48px' }}>
        <div style={{ position: 'absolute', inset: '-8px', zIndex: 0, backgroundImage: `url("${theme.leftImage}")`, backgroundSize: 'cover', backgroundPosition: 'center', filter: isSalon ? 'blur(0.5px) brightness(0.82) saturate(1.05)' : 'blur(0.5px) brightness(0.80) saturate(1.10)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none', background: theme.leftOverlay, opacity: 0.58 }} />
