  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="login-left-panel" style={{
        ...
        {/* CAPA 1 — Imagen barbería, bien visible */}
        <div style={{
          ...
          filter: 'blur(0.5px) brightness(0.68) saturate(1.10)',
          pointerEvents: 'none',
        }} />
        {/* CAPA 2 — Overlay teal fino — solo para dar el tinte verde sin tapar la foto */}
        <div style={{
          position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none',
          background: 'linear-gradient(145deg, rgba(11,31,28,0.42) 0%, rgba(22,46,42,0.35) 50%, rgba(100,152,175,0.28) 100%)',
        }} />
      ...
      <div style={{
        ...
        background: 'hsl(175 60% 8%)',  /* fallback */
        position: 'relative', overflow: 'hidden',
      }}>
        {/* CAPA 1 — Imagen diferente: barber cutting hair, más oscura */}
        <div style={{
          position: 'absolute', inset: '-8px', zIndex: 0, pointerEvents: 'none',
          backgroundImage: 'url("https://images.unsplash.com/photo-1621605815971-fbc98d665033?auto=format&fit=crop&w=1400&q=80")',
          backgroundSize: 'cover', backgroundPosition: 'center top',
          filter: 'blur(0.5px) brightness(0.42) saturate(0.85)',
        }} />
        {/* CAPA 2 — Overlay verde oscuro profundo */}
        <div style={{
          position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none',
          background: 'linear-gradient(160deg, rgba(11,31,28,0.78) 0%, rgba(15,42,38,0.72) 50%, rgba(22,46,42,0.80) 100%)',
        }} />
        {/* CAPA 3 — Orbe teal sutil encima del overlay */}
        <div style={{
          position: 'absolute', top: -80, right: -80, width: 360, height: 360,
          borderRadius: '50%', pointerEvents: 'none', zIndex: 2,
          background: 'radial-gradient(circle, rgba(100,152,175,0.12) 0%, transparent 70%)',
        }} />
